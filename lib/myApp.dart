...
class MyApp extends StatelessWidget {
  ...
  const MyApp({super.key, required this.wordManager, required this.modalManager, required this.wordListManager, required this.wordEditorManager});

  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: MainShell(wordManager: wordManager, wordListManager: wordListManager, modalManager: modalManager, wordEditorManager: wordEditorManager),
    );
  }
}
